...
class MainTest(unittest.TestCase):
    def word_check_helper(
        ...
        should_have_pronunciation_url
    ):
        parsed = dictcom.get_word(word)
        self.assertIsInstance(parsed, dictcom.Word.Word)
    ...
    #             print(word)
    #             raise e
    #         dictcom.parse.print_word(word, word_defs)
    #
